...
def main():
   ...
   GRID_DATA_PATH = "/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/TRENTO/parralel_batch/5-10/JOBS_GRID10_RUN3"
   ALICE_DATA_PATH = "/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/5-10"
   ...
   chi = "python2 " + MACROS_PATH + "/chi/make_chi_square_batch_510.py "
   writeToTree = "python2 " + MACROS_PATH + "/chi/write_to_tree_510.py " + WORKING_FOLDER_PATH + " " + jobFolder + " pion" 
