...
def main():
   ...
   #combinations = open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/TRENTO/parralel_batch/confs_9D/grid_3bins_norm4.dat", "r")
   ...
   if which_particle == 1:
      ...
      Data = json.load(open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/20-30/pion/pi0139plu.json", "r"))
      DataError = json.load(open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/20-30/pion/fullError.json", "r"))
   ...
   if which_particle == 2:
      ...
      Data = json.load(open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/20-30/kaon/Ka0492plu.json", "r"))
      DataError = json.load(open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/20-30/kaon/fullError.json", "r"))
   ...
   if which_particle == 3:
      ...
      Data = json.load(open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/20-30/proton/pr0938plu.json", "r"))
      DataError = json.load(open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/20-30/proton/fullError.json", "r"))
