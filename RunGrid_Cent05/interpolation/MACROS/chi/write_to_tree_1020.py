...
def main():
   ...
   ChiYaml =   glob.glob("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/TRENTO/parralel_batch/macro_batch/JOBS/" + jobFolder + "/" + particleFolder + "/chi_*")
   ChiYaml.sort(key=sortKeyFunc)
