...
write_file =       open("lambdaMinus.json", "w")
write_file_pt =    open("pt_lambdaMinus.json", "w")
write_file_sys =   open("sys_lambdaMinus.json", "w")
write_file_stat =  open("stat_lambdaMinus.json", "w")
write_file_error = open("fullError.json", "w")

f = ROOT.TFile("HEPData-ins1243863-v1-root.root", "READ")

dir = f.GetDirectory("Table 8"); #  Lambda 0-5%
