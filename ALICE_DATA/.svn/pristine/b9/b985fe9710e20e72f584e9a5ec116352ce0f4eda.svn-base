...
write_file = open("xiMinus.json", "w")
write_file_pt = open("pt_xiMinus.json", "w")
write_file_sys = open("sys_xiMinus.json", "w")
write_file_stat = open("stat_xiMinus.json", "w")
write_file_error = open("fullError.json", "w")

f = ROOT.TFile("HEPData-ins1243865-v1-root.root", "READ")

dir = f.GetDirectory("Table 2"); # Xi    10-20%
