...
SetDirectory[StringJoin[StringDelete[WORKINGFOLDER, "/RunGrid-Cent3040"], "/FluiduM-newResList", "/Package"]]
...
RunHydroUntilFreezeOut[entropyXtau0_, etas_, bulk_, tch_, tau0_]:=Module[{myGrid,myFluidProperties,initialTrento,HydroSolution,myFluidFieldsOnFreezeOutSurface},
        ...
        initialTrento = setInitialConditionsCentrality[{{30, 40}}, entropyXtau0, tau0, myFluidProperties, myGrid, rprofile, wprofile, averageMultiplicity][[1]];
