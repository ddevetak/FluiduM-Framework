...
def main():
   ...
   chi =         "python " + WORKING_FOLDER + "/interpolation/MACROS/chi/make_chi_square_batch_3040.py " + WORKING_FOLDER  + " "
   writeToTree = "python " + WORKING_FOLDER + "/interpolation/MACROS/chi/write_to_tree_3040.py " + WORKING_FOLDER + "/interpolation/JOBS/ " + jobFolder
