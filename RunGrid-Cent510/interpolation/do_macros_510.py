...
def main():
   ...
   PionAlicePT =   ALICE_DATA_PATH + "/5-10/pion/pt_pi0139plu.json"
   KaonAlicePT =   ALICE_DATA_PATH + "/5-10/kaon/pt_Ka0492plu.json"
   ProtonAlicePT = ALICE_DATA_PATH + "/5-10/proton/pt_pr0938plu.json"
   ...
   chi =         "python2 " + WORKING_FOLDER + "/interpolation/MACROS/chi/make_chi_square_batch_510.py " + WORKING_FOLDER  + " "
   writeToTree = "python2 " + WORKING_FOLDER + "/interpolation/MACROS/chi/write_to_tree_510.py " + WORKING_FOLDER + "/interpolation/JOBS/ " + jobFolder
