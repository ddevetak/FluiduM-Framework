...
dataC = Import[StringJoin[WORKINGFOLDER, "RunGrid_Cent1020/grid_10bins_27_08.dat"]]
...
RunHydroUntilFreezeOut[entropyXtau0_, etas_, bulk_, tch_, tau0_]:=Module[{myGrid,myFluidProperties,initialTrento,HydroSolution,myFluidFieldsOnFreezeOutSurface},
        ...
        initialTrento = setInitialConditionsTrento[{ {10, 20} }, entropyXtau0, tau0, myFluidProperties, myGrid][[1]];
...
StoringFileFolder = Table[StringJoin[WORKINGFOLDER, "RunGrid_Cent1020/JOBS/", JobFolder, particleFolders[[i]]],{i,3}];
