...
def main():
   ...
   #combinations = open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/TRENTO/parralel_batch/confs_9D/grid_3bins_norm2.dat", "r")
   ...
   if which_particle == 1:
      ...
      Data = json.load(open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/5-10/pion/pi0139plu.json", "r"))
      DataError = json.load(open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/5-10/pion/fullError.json", "r"))
   ...
   if which_particle == 2:
      ...
      Data = json.load(open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/5-10/kaon/Ka0492plu.json", "r"))
      DataError = json.load(open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/5-10/kaon/fullError.json", "r"))
   ...
   if which_particle == 3:
      ...
      Data = json.load(open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/5-10/proton/pr0938plu.json", "r"))
      DataError = json.load(open("/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/5-10/proton/fullError.json", "r"))
