...
def main():
   ...
   GRID_DATA_PATH = "/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/TRENTO/parralel_batch/30-40/JOBS_GRID10_RUN3"
   ALICE_DATA_PATH = "/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/30-40"
   ...
   chi = "python2 " + MACROS_PATH + "/chi/make_chi_square_batch_3040.py "
   writeToTree = "python2 " + MACROS_PATH + "/chi/write_to_tree_3040.py " + WORKING_FOLDER_PATH + " " + jobFolder + " pion" 
