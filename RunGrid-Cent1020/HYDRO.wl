...
SetDirectory[StringJoin[StringDelete[WORKINGFOLDER, "/RunGrid-Cent1020"], "/FluiduM-newResList", "/Package"]]
...
RunHydroUntilFreezeOut[entropyXtau0_, etas_, bulk_, tch_, tau0_]:=Module[{myGrid,myFluidProperties,initialTrento,HydroSolution,myFluidFieldsOnFreezeOutSurface},
        ...
        initialTrento = setInitialConditionsCentrality[{{10, 20}}, entropyXtau0, tau0, myFluidProperties, myGrid, rprofile, wprofile, averageMultiplicity][[1]];
