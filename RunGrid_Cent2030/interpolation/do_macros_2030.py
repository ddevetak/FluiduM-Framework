...
def main():
   ...
   GRID_DATA_PATH = "/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/TRENTO/parralel_batch/20-30/JOBS_GRID10_RUN3"
   ALICE_DATA_PATH = "/lustre/nyx/alice/users/ddevetak/FluiduM/ALICE/ALICE_DATA/20-30"
   ...
   chi = "python2 " + MACROS_PATH + "/chi/make_chi_square_batch_2030.py "
   writeToTree = "python2 " + MACROS_PATH + "/chi/write_to_tree_2030.py " + WORKING_FOLDER_PATH + " " + jobFolder + " pion" 
