...
dataC = Import[StringJoin[WORKINGFOLDER, "RunGrid_Cent2030/grid_10bins_27_08.dat"]]
...
RunHydroUntilFreezeOut[entropyXtau0_, etas_, bulk_, tch_, tau0_]:=Module[{myGrid,myFluidProperties,initialTrento,HydroSolution,myFluidFieldsOnFreezeOutSurface},
        ...
        initialTrento = setInitialConditionsTrento[{ {20, 30} }, entropyXtau0, tau0, myFluidProperties, myGrid][[1]];
...
StoringFileFolder = Table[StringJoin[WORKINGFOLDER, "RunGrid_Cent2030/JOBS/", JobFolder, particleFolders[[i]]],{i,3}];
